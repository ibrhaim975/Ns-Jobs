...
@Component({
    selector: 'app-config',
    template: `
        <a style="cursor: pointer;display:none" id="layout-config-button" class="layout-config-button" (click)="onConfigButtonClick($event)">
            <i class="pi pi-cog"></i>
        </a>
...
export class AppConfigComponent implements OnInit,AfterViewInit {
    ...
    ngAfterViewInit(): void{
        ...
        this.appMain.sidebarStatic = false;
